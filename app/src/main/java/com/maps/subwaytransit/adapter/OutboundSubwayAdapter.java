...
public class OutboundSubwayAdapter extends ArrayAdapter<StationScheduleModel> {
    private Context context;

    private ArrayList<StationScheduleModel> subwayDestinationName = new ArrayList<>();

    public OutboundSubwayAdapter(Context context, ArrayList<StationScheduleModel> subwayDestinationName) {
